...
$sentencia = $base_de_datos->query("SELECT * FROM listaa;");
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $alumno->costo ?></td>
					<td><a class="btn btn-warning" href="<?php echo "editarA.php?matricula=" . $alumno->matricula?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
