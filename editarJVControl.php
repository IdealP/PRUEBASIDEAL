...
<?php
	...
	<head>
		...
		<title>Editar Control JOS VAS</title>
	...
	<div class="col-xs-12">
		<br><br>
		<form method="post" action="guardarDatosEditadosJVControl.php">
			...
			<a class="btn btn-warning" href="./listaMesJVControl.php">Cancelar</a> -->
